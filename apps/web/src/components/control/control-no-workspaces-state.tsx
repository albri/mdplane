...
import { AUTH_FRONTEND_ROUTES, URLS } from '@mdplane/shared'
...
export function ControlNoWorkspacesState() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl items-center justify-center p-4 sm:p-8" data-testid="control-no-workspaces-state">
      <Card className="w-full border-border/80 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-xs text-muted-foreground">
            ...
            {' '}|{' '}
            <a
              href={`${URLS.DOCS}/docs/access-and-auth`}
              className="underline hover:text-foreground"
              target="_blank"
              rel="noopener noreferrer"
            >
