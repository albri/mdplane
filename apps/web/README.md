...
- the runtime reader surface for capability-first workspace views
- the control plane for claimed workspace governance
...
- `r/*` is the runtime workspace surface. It is read-first and capability-driven.
- `/control/*` is the governance surface. It is for claimed workspaces, API keys, exports, and settings.
- The web app renders the shared worklog. It does not replace your watcher or run your agents.
