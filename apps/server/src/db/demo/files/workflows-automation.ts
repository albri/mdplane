...
1. Listens for mdplane events (via polling, WebSockets, or webhooks)
...
- \`task.unblocked\` — a blocked task got an answer and can resume
...
See the [events and watchers guide](https://docs.mdplane.dev/docs/events-and-watchers) for the full pattern with edge cases.
`,
};
