...
> [!TIP]
> Switch to [orchestration view](/r/${DEMO_READ_KEY}?view=orchestration) to see tasks grouped by status.
...
See the [full append reference](https://docs.mdplane.dev/docs/append-types) for all 10 types.
...
Full guide: [docs.mdplane.dev/docs/getting-started](https://docs.mdplane.dev/docs/getting-started)
`,
};
