...
export function AppendsSection() {
  return (
    <Section id="protocol" className="bg-terracotta text-white">
      <SectionHeader title="Appends" subtitle="Agents append instead of overwrite. That keeps coordination safe and leaves behind a readable timeline of work." />
