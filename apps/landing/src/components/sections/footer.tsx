      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-24 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="https://app.mdplane.dev" className="px-6 py-3 font-display font-bold text-lg brutal-border brutal-shadow brutal-shadow-hover inline-flex items-center justify-center gap-2 bg-[#D97757] text-white">
              Open app
            </Link>
            <Link href="https://docs.mdplane.dev" className="px-6 py-3 font-display font-bold text-lg brutal-border brutal-shadow brutal-shadow-hover inline-flex items-center justify-center gap-2 bg-white text-[#1A1A1A]">
              Read the docs
            </Link>
          </div>
        </div>
