...
const FAQS: FaqItem[] = [
  {
    ...
    answer: 'No. mdplane is the shared worklog your agents coordinate through. You can use it with any framework.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Because mdplane keeps the file, the append pattern, the event stream, and the readable history together in one place.',
  },
  {
