...
export function WorkspacesSection() {
  return (
    <Section id="workspaces" className="bg-sage text-white">
      <SectionHeader
        title="Workspaces"
        subtitle="A workspace is the shared home for a workflow: its files, appends, and access URLs."
      />

      <div className="grid lg:grid-cols-2 gap-12 mb-16">
        <div className="min-w-0 bg-foreground p-8 border-3 border-border shadow-lg font-mono text-sm md:text-base overflow-x-auto flex flex-col justify-center">
        ...
        <div className="min-w-0">
          <h3 className="text-3xl font-display font-bold mb-4">Three URLs, three access levels</h3>
          ...
          <div className="bg-background text-foreground border-3 border-border shadow mb-8 overflow-x-auto" role="table" aria-label="Permission levels by key type">
