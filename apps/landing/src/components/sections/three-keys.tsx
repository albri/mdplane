  ...
  return (
    <Section className="bg-sage text-white">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        {keys.map((card, i) => (
          <div key={i} className={`${card.color} ${card.text} p-8 border-3 border-border shadow-lg transform transition-transform hover:-translate-y-2`}>
            ...
            <div className="bg-white/50 p-3 border-3 border-border flex items-center gap-3">
              <Key size={20} />
      ...
      <div className="text-center">
        <p className="text-3xl font-display font-bold inline-block bg-foreground text-white px-8 py-4 border-3 border-border">
