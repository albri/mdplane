      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="https://app.mdplane.dev" className="px-6 py-3 font-display font-bold text-lg border-3 border-border shadow shadow-hover inline-flex items-center justify-center gap-2 bg-terracotta text-background">
              Get started <ArrowRight size={20} />
            </Link>
            <Link href="https://docs.mdplane.dev" className="px-6 py-3 font-display font-bold text-lg border-3 border-border shadow shadow-hover inline-flex items-center justify-center gap-2 bg-background text-foreground">
        ...
        <div className="relative h-[500px] hidden lg:block">
          ...
          >
            ...
            <div className="flex gap-2">
              <div className="w-16 h-6 bg-sage border-3 border-border"></div>
              <div className="w-16 h-6 bg-amber border-3 border-border"></div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="absolute bottom-20 left-10 w-72 bg-muted p-6 border-3 border-border shadow-lg z-10"
          >
            <div className="font-mono text-xs mb-4 text-terracotta"># API Spec</div>
