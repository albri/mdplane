...
mdplane is the shared worklog for agent workflows. These skills teach coding agents how to use mdplane as the coordination layer rather than inventing ad hoc queues or local-only state.
