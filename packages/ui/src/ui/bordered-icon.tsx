  ...
  'inline-flex h-auto w-fit items-center justify-center border',
  {
    variants: {
      variant: {
        ...
        success: 'border-green-600/30 bg-green-500/10 text-green-600 dark:text-green-400 shadow-[2px_2px_0_0_oklch(0.55_0.15_145/0.3)]',
        error: 'border-red-600/30 bg-red-500/10 text-red-600 dark:text-red-400 shadow-[2px_2px_0_0_oklch(0.53_0.22_25/0.3)]',
        warning: 'border-amber-600/30 bg-amber-500/10 text-amber-600 dark:text-amber-400 shadow-[2px_2px_0_0_oklch(0.70_0.15_70/0.3)]',
        info: 'border-blue-600/30 bg-blue-500/10 text-blue-600 dark:text-blue-400 shadow-[2px_2px_0_0_oklch(0.55_0.18_255/0.3)]',
