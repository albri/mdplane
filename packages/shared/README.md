...
This package is the contract spine of mdplane. It holds the generated API types, query schemas, route constants, shared limits, and shared product messaging used across the app, docs, and landing surfaces.
