...
export interface paths {
    ...
    "/r/{key}/folders": {
         ...
         * @description List contents of the workspace root folder including files and subfolders.
         *
         *     Supports the same pagination, sorting, and export options as scoped folder listing.
         */
        get: operations["listRootFolderContents"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/a/{key}/folders": {
        ...
        /**
         * List root folder contents (append key)
         * @description List root folder contents using an append key. Append keys inherit all read capabilities.
         *     Returns file append URLs in response.
         */
        get: operations["listRootFolderContentsViaAppendKey"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/a/{key}/folders/claims": {
        ...
        /**
         * List root folder claims
         * @description List claims across all files in the workspace root folder.
         */
        get: operations["listRootFolderClaims"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/w/{key}/folders": {
        ...
        /**
         * List root folder contents (write key)
         * @description List root folder contents using a write key. Write keys inherit all read capabilities.
         *     Returns file write URLs in response.
         */
        get: operations["listRootFolderContentsViaWriteKey"];
        put?: never;
        /**
         * Create new folder
    ...
    "/w/{key}/folders/files": {
         ...
         * @description Create a new file in the workspace root folder. Requires write key.
         *
         ...
         */
        post: operations["createFileInRootFolder"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/w/{key}/folders/copy": {
         ...
         * @description Copy a file from another location into the workspace root folder.
         *
         *     Requires a source file key (read access to source file).
         *     Optionally specify a new filename.
         */
        post: operations["copyFileToRootFolder"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/w/{key}/folders/bulk": {
        ...
        put?: never;
        /**
         * Bulk create files in root folder
         * @description Create multiple files in the workspace root folder in a single request.
         *
         ...
         */
        post: operations["bulkCreateFilesInRootFolder"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/w/{key}/folders/settings": {
        ...
        /**
         * Get root folder settings
         * @description Get settings for the workspace root folder including WIP limits, claim duration,
         *     and other coordination settings.
         */
        get: operations["getRootFolderSettings"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
        /**
         * Update root folder settings
         * @description Update settings for the workspace root folder. Only provided fields are updated.
         */
        patch: operations["updateRootFolderSettings"];
        trace?: never;
    };
...
export interface operations {
    ...
    listRootFolderContents: {
        parameters: {
            query?: {
                ...
                cursor?: components["parameters"]["cursor"];
                /**
                 * @description Special action to perform. When set to `export`, returns root contents as
                 *     a downloadable archive instead of JSON listing.
                 */
                action?: "export";
                /** @description Archive format (only used when action=export) */
    ...
    listRootFolderContentsViaAppendKey: {
        parameters: {
            query?: {
                /** @description Maximum number of items to return */
                limit?: components["parameters"]["limit"];
    ...
    listRootFolderClaims: {
        ...
        requestBody?: never;
        responses: {
            /** @description Root folder claims retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listRootFolderContentsViaWriteKey: {
        parameters: {
            query?: {
                /** @description Maximum number of items to return */
                limit?: components["parameters"]["limit"];
    ...
    getRootFolderSettings: {
        ...
        requestBody?: never;
        responses: {
            /** @description Root folder settings retrieved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateRootFolderSettings: {
        ...
        responses: {
            /** @description Root folder settings updated successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                     ...
                     *       "data": {
                     *         "id": "key_1",
                     *         "key": "sk_live_demoKey12345678901234",
                     *         "name": "CI Pipeline",
                     *         "permissions": [
                     *           "read",
                     *           "append"
